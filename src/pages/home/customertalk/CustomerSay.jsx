...
const CustomerSay = () => {
    return (
        <div className='space-y-5 mt-25 flex flex-col justify-center items-center text-center'>
            <img src={cuctomer} alt="" />
            <h1 className='text-5xl font-extrabold text-[#03373D]'>What our customers are sayings</h1>
